...
class PlantMonitoringPage extends StatefulWidget {
  ...
  PlantMonitoringPage({required this.plantDoc});
...
class _PlantMonitoringPageState extends State<PlantMonitoringPage> {
  ...
  List<bool> _wateredDays = List<bool>.filled(7, false);
  List<String> _dates = List.generate(7, (index) {
  ...
  List<QueryDocumentSnapshot> _filterDocsByInterval(List<QueryDocumentSnapshot> docs, String interval) {
    if (interval == 'Weekly') {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Perkembangan Tanaman", style: TextStyle(fontSize: 20)),
        leading: IconButton(
      ...
      body: Padding(
        padding: const EdgeInsets.only(left: 20.0, right: 5.0, top: 5.0, bottom: 10.0),
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text("Pertumbuhan Tanaman", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  var filteredDocs = _filterDocsByInterval(docs, _selectedInterval);
                            ...
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (value, meta) {
                                return SideTitleWidget(
                                  ...
                                  child: Text(dates[value.toInt() % dates.length]),
                                );
                              },
                            ),
                          ),
